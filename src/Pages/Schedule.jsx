...
const Schedule = () => {
    ...
    piketGroup = [
        ["Haikal", "Jenia", "Juaz", "Kyara", "Marisha", "Malaika", "Osel", "Rafi N", "Vadhel"], // Senin
    ["Afgan", "Devany", "Musafa", "Anika", "Fatimah", "Repan", "Raka", "Pino", "Yasmin"], // Selasa
    ["Aura", "Ana", "Carissa", "Ziyaa", "M.Arfan", "M.Eeng", "Nabil", "Rizky", "Oji"], // Rabu
    ["Aqsya", "Dinar", "Galih", "Lutfia", "M.Habibi", "M.Raihan", "Putri R", "Sindy"], // Kamis
    ["Abiyyu", "Abiyan", "Akbar", "Naomi", "Rafi A", "Saadatul", "Syalwa", "Zahra"], // Jumat
    ]
        ...
        <>
                ...
                <div className="text-white flex flex-col justify-center items-center mt-8 md:mt-3 overflow-y-hidden">
                    ...
                    <div data-aos="fade-up" data-aos-duration="400">
                        {TodayComponent ? (
                            ...
                            <p className="opacity-50">Tidak Ada Jadwal Hari Ini, Selamat Menikmati Hari Liburmu :)</p>
                        )}
                    </div>
                </div>
            </div>
            ...
            <div className="text-white flex flex-col justify-center items-center mt-8 lg:mt-0 lg:mb-[10rem] mb-10 overflow-y-hidden">
                ...
                {currentPiketNames && currentPiketNames.length > 0 ? (
                    ...
                    <p className="opacity-50">Tidak Ada Jadwal Hari Ini #LihhPtrsv</p>
                )}
            </div>
        </>
    )
