	...
	return (
		<div className="z-1 relative h-auto lg:overflow-hidden">
			...
			<div data-aos="fade-up" data-aos-duration="500" className="mt-14 md:mt-10">
				<BorderStruktur Jabatan="Wali Kelas" Nama="Djunaedi Lubis S.Pdi" Width="150px" />
			</div>
			<div className="flex flex-col justify-center items-center">
				...
				<div className="flex relative top-[-3rem]" data-aos="fade-up" data-aos-duration="1200">
					<div className="relative left-[0.2rem]">
						<BorderStruktur Jabatan="Ketua Kelas" Nama="Nabil" Width="120px" />
					</div>
					...
					<div className="relative right-[0.2rem]">
						<BorderStruktur Jabatan="Wakil Ketua" Nama="Jenia" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Sekertaris" Nama="Naomi" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Marisha" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Bendahara" Nama="Galih Putra" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Awa" Width="120px" />
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Keamanan" Nama="Abyan" Width="120px" />
						<div className="py-[2%]"></div>
						<BorderStruktur Jabatan="" Nama="Fahruroji" Width="120px" />
						<BorderStruktur Jabatan="" Nama="Alvino" Width="120px" />
						<BorderStruktur Jabatan="" Nama="Sindy" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Kebersihan" Nama="Putri R" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Yasmin" Width="120px" />
						<BorderStruktur Jabatan="" Nama="Lutfia" Width="120px" />
					</div>

					<div className="flex-col hidden lg:flex">
						<BorderStruktur Jabatan="Kesehatan" Nama="Zahra" Width="120px" />
						<div className="py-[3%]"></div>
						<BorderStruktur Jabatan="" Nama="Akbar" Width="120px" />
						<BorderStruktur Jabatan="" Nama="Rehan" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					<div className="flex-col">
						<BorderStruktur Jabatan="Kesehatan" Nama="Akbar" Width="120px" />
					</div>
				</div>
				...
				<div
					...
					data-aos-duration="1100">
					<div className="flex-col">
						<BorderStruktur Jabatan="Keagamaan" Nama="Abiyu" Width="120px" />
						<BorderStruktur Jabatan="Dekorasi" Nama="Ziyaa" Width="120px" />
					</div>

					<div className="flex-col">
						<BorderStruktur Jabatan="Keagamaan" Nama="Dinar" Width="120px" />
						<BorderStruktur Jabatan="Dekorasi" Nama="Putri F" Width="120px" />
					</div>
				</div>
				...
				<div className=" absolute bottom-[15%] lg:bottom-[20%] " data-aos="fade-up" data-aos-duration="1000">
					<div className="flex justify-center items-center flex-col">
						...
						<div className="relative bottom-3">
							<BorderStruktur Jabatan="Keagamaan" Nama="Musafa" Width="120px" />
							<BorderStruktur Jabatan="Dekorasi" Nama="Osel" Width="120px" />
							<BorderStruktur Jabatan="Dekorasi" Nama="Carissa" Width="120px" />
						</div>
					</div>
				</div>
