					...
					<div class="grid grid-cols-2 sm:grid-cols-3">
						<div className=" ">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://www.instagram.com/t._.xshylh/?hl=id" class="hover:underline">
										GALIH PUTRA
									</a>
								</li>
								<li>
						...
						<div className="">
							...
							<ul class="text-gray-400 dark:text-gray-400 font-medium">
								<li class="mb-2">
									<a href="https://github.com/LihhCode7" class="hover:underline ">
										Github
									</a>
								</li>
								<li>
									<a href="https://www.tiktok.com/@lihhptrsv?_t=8qJJq37xdJa&_r=1://www.youtube.com/@11TKJ3" class="hover:underline">
										Tiktok
									</a>
								</li>
							</ul>
				...
				<div class="sm:flex sm:items-center sm:justify-between">
					<div class="flex mt-4 justify-center sm:mt-0">
						<p className="text-[0.7rem] text-white opacity-70">
							© {new Date().getFullYear()} Kelas X DESKOV PLUS | Di Kelola Oleh Siswa X DKV PLUS
						</p>
					</div>
				</div>
			</div>
